 ...
 *------------------------------------------------------------------------------
 * $Revision:   1.10  $
 * $Modtime:   Oct 25 2005 12:20:14  $
 * $Log:   //mtkvs01/vmdata/meta_app/archives/MauiMETA/Man/man_timer.h-arc  $
 *
 ...
 *
 *    Rev 1.6   Jan 10 2005 11:14:32   mtk00490
...
class  TTimerMan: public TThread
{
public:

    __fastcall TTimerMan( void );
...
public:  // Public interface
    ...
    void  CounterStart( int timeout_in_ms, void (*callback)(void) );
    void  CounterRestart( int timeout_in_ms );
    void  CounterStop( void );
    void  TimeOut( void );
};

extern  TTimerMan *TimerMan;

 ...
 *------------------------------------------------------------------------------
 * $Revision:   1.9  $
 * $Modtime:   Oct 25 2005 12:16:10  $
 * $Log:   //mtkvs01/vmdata/meta_app/archives/MauiMETA/Man/man_active.h-arc  $
 *
 *    Rev 1.9   Oct 25 2005 14:15:14   mtk00490
 * IP2 calibration support Skyworks 74117, 74400
 *
 *    Rev 1.8   Sep 04 2005 11:06:40   mtk00490
 ...
 *
 *    Rev 1.7   Apr 18 2005 15:49:08   mtk00490
 * crystal AFC calibration fine tune
 *
 *    Rev 1.6   Jan 30 2005 17:57:44   mtk00490
 * Audio
 ...
 *
 *    Rev 1.5   Jan 10 2005 11:14:16   mtk00490
...
class  TActiveMan: public TThread
{
public:

    __fastcall TActiveMan( void );
    void __fastcall TerminateThread(void);
    void __fastcall Execute( void );

    void  (*ActiveFunction)(void);
    void  (*ActiveFunction2)(void);

    void  (*ExcuteActiveFunction)(void);
    void  (*ExcuteActiveFunction2)(void);
    bool  is_suspend;
...
public:  // Public interface
    ...
    void  SetActiveFunction( void  (*func)(void) );
    void  SetActiveFunction2( void  (*func)(void) );

};

extern  TActiveMan *ActiveMan;
/*---------------------------------------------------------------------------*/
#endif
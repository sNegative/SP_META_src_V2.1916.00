...
public:
    ...
    NFC_EM_ALS_READERM_CNF_S m_readerCnf;
    NFC_EM_ALS_READERM_NTF_S m_readerNtf;
    NFC_EM_ALS_READERM_OPT_CNF_S m_readerOptCnf; 
    NFC_READER_RSP_S m_nfc_rsp;
    
    bool m_bAlsReaderModeStart;
    bool REQ_ALS_READER_MODE_Start(NFC_READER_RSP_S nfc_rsp,NFC_EM_ALS_READERM_REQ_S *readerReq);

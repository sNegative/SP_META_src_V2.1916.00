 ...
 *------------------------------------------------------------------------------
 * $Revision:   1.6  $
 * $Modtime:   Oct 25 2005 12:23:36  $
 * $Log:   //mtkvs01/vmdata/meta_app/archives/MauiMETA/Misc/GSM_utils.h-arc  $
 *
 ...
 *
 *
 *    Rev 1.6   Oct 25 2005 14:15:28   mtk00490
 * IP2 calibration support Skyworks 74117, 74400
 *
 *    Rev 1.5   Sep 04 2005 11:07:04   mtk00490
 ...
 *
 *    Rev 1.4   Apr 18 2005 15:49:22   mtk00490
 * crystal AFC calibration fine tune
 *
 *    Rev 1.3   Jan 30 2005 17:58:14   mtk00490
 * Audio
 ...
 *
 *    Rev 1.2   Jan 10 2005 11:14:48   mtk00490
...
/*---------------------------------------------------------------------------*/
// frequency
extern bool getCenterFreq(FrequencyBand Band, int ARFCN, bool isDownlink, double *CenterFreq);
// TX power
extern bool NominalPower_To_PCL(FrequencyBand Band, int min_dBm, int &pcl);
extern bool PCL_To_NominalPower(FrequencyBand Band, int pcl, int &min_dBm);
extern short dBm_To_PCL(E_BANDSEL BandSel, double dBm);
extern bool PCL_To_PCLIndex(E_BANDSEL BandSel, short pcl, short &pcl_idx);
extern bool PCLIndex_To_PCL(E_BANDSEL BandSel, short pcl_idx, short &pcl);
extern short Get_FirstPCL(E_BANDSEL BandSel);
extern short Get_LastPCL(E_BANDSEL BandSel);

// channel
extern short Get_SeperateChannel(int vi_band, short arfcn);
#endif

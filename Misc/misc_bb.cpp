...
{
    RANGE_CHECK_ERROR(! AnsiString_To_UnsignedShort( ansi_str, measure_count, 0, 1000 ), RANGE_ERR_MEASURE_COUNT);
    return true;
}
...
//---------------------------------------------------------------------------
bool  IsValidHexRegValue(AnsiString ansi_str, unsigned int *value)
{
    //unsigned int  idata = value;
    RANGE_CHECK_ERROR( !AnsiString_Hex_To_UnsignedInt(ansi_str, value), RANGE_ERR_REG_VALUE);
...
//---------------------------------------------------------------------------
bool  IsValidDecRegValue(AnsiString ansi_str, unsigned int *value)
{
    //int  idata;
    //RANGE_CHECK_ERROR(! AnsiString_To_UnsignedInteger(ansi_str, value, 0, 4294967295), RANGE_ERR_REG_VALUE);
    RANGE_CHECK_ERROR(! AnsiString_To_UnsignedInteger(ansi_str, *value, 0, 4294967295), RANGE_ERR_REG_VALUE);
...
{
    RANGE_CHECK_ERROR(!AnsiString_To_UnsignedChar(ansi_str, level, 0, 255), RANGE_ERR_LED_LIGHT_LEVEL);
    return true;
}

bool  IsValidLEDDiv(AnsiString ansi_str, unsigned char &level)
{
    RANGE_CHECK_ERROR(!AnsiString_To_UnsignedChar(ansi_str, level, 0, 255), RANGE_ERR_LED_LIGHT_LEVEL);
    return true;
}

bool  IsValidLEDDuty(AnsiString ansi_str, unsigned char &level)
{
    RANGE_CHECK_ERROR(!AnsiString_To_UnsignedChar(ansi_str, level, 0, 255), RANGE_ERR_LED_LIGHT_LEVEL);
    return true;
}

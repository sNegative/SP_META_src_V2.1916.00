 ...
 * Description:
 * ------------
 *   Serial link authentication header
 *
 * Author:
 * -------
 *  Andy Ueng (mtk00490)
...
#define  STATE_SLA_OK          0
#define  STATE_SLA_FAIL        1
#define  STATE_SLA_TIMEOUT     2
#define  STATE_SLA_STOP        3
...
public:
    ...
    bool  REQ_AUTH_Destroy( void );
    bool  REQ_AUTH_Load( const char *auth_filepath );
    bool  REQ_AUTH_Unload( void );
